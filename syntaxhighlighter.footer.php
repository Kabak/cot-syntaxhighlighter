...
$(function(){if($('pre').length>0){ $('head').append('$sh_core_css');var sh_e1=document.createElement('script');sh_e1.async=true;sh_e1.src ='$sh_core_js';document.getElementById('body').appendChild(sh_e1);}});
JS
);
